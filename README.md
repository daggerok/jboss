...
JBOSS WildFly 10.0.0.Final docker image (Linux Alpine, OpenJDK 8u151)
...
FROM daggerok/jboss:wildfly-10.0.0.Final
...
FROM daggerok/jboss:wildfly-10.0.0.Final-alpine

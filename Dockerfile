...
ENV JBOSS_FILE="${JBOSS_USER}.0.Beta.zip" \
...
#          || exit 1                                                                            #
# COPY --chown=jboss-eap-7.2 ./target/*.war ${JBOSS_HOME}/standalone/deployments/my-service.war #
#################################################################################################
...
# FROM daggerok/jboss:eap-7.2                                                                   #
# COPY --chown=jboss-eap-7.2 ./app.ear ./target/*.war ${JBOSS_HOME}/standalone/deployments/     #
#################################################################################################

...
############################################ USAGE ##############################################
# FROM daggerok/jboss:eap-6.2                                                                   #
# HEALTHCHECK --timeout=2s --retries=22 \                                                       #
#         CMD wget -q --spider http://127.0.0.1:8080/my-service/health \                        #
#          || exit 1                                                                            #
# COPY --chown=jboss-eap-6.2 ./target/*.war ${JBOSS_HOME}/standalone/deployments/my-service.war #
#################################################################################################
...
# FROM daggerok/jboss:eap-6.2                                                                   #
# COPY --chown=jboss-eap-6.2 ./app.ear ./target/*.war ${JBOSS_HOME}/standalone/deployments/     #
#################################################################################################

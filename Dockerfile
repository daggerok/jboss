...
# docker tag daggerok/jboss-wildfly daggerok/jboss-wildfly:11.0.0.Final
...
ENV JBOSS_URL="http://download.jboss.org/wildfly/${JBOSS_WILDFLY_VERSION}/wildfly-${JBOSS_WILDFLY_VERSION}.zip" \
